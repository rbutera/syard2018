...
import static uk.ac.bris.cs.scotlandyard.harness.ImmutableScotlandYardView.TicketAbbr.*;
import static uk.ac.bris.cs.scotlandyard.harness.ImmutableScotlandYardView.*;
...
title Sample game sequence(6 player, 4 rounds)
legend right
Type legend
...
deactivate MrX
rnote over ScotlandYardModel: Round=0, CurrentPlayer=Blue
...
deactivate Red
rnote over ScotlandYardModel: Round=2, CurrentPlayer=White
ScotlandYardModel->Spectator: onMoveMade(V, Ticket)
ScotlandYardModel -> White: makeMove(V, int, Move[], callback<Move>)
activate White
	White-->ScotlandYardModel : Consumer.accept(Ticket)
deactivate White
rnote over ScotlandYardModel: Round=2, CurrentPlayer=Yellow
ScotlandYardModel->Spectator: onMoveMade(V, Ticket)
...
activate Blue
	Blue-->ScotlandYardModel : Consumer.accept(Ticket)
deactivate Blue
rnote over ScotlandYardModel: Round=4, CurrentPlayer=Green
ScotlandYardModel->Spectator: onMoveMade(V, Ticket)
ScotlandYardModel -> Green: makeMove(V, int, Move[], callback<Move>)
activate Green
	Green-->ScotlandYardModel : Consumer.accept(Ticket)
...
activate Red
	Red-->ScotlandYardModel : Consumer.accept(Ticket)
deactivate Red
rnote over ScotlandYardModel: Round=4, CurrentPlayer=White
ScotlandYardModel->Spectator: onMoveMade(V, Ticket)
ScotlandYardModel -> White: makeMove(V, int, Move[], callback<Move>)
activate White
	White-->ScotlandYardModel : Consumer.accept(Ticket)
deactivate White
rnote over ScotlandYardModel: Round=4, CurrentPlayer=Yellow
ScotlandYardModel->Spectator: onMoveMade(V, Ticket)
ScotlandYardModel -> Yellow: makeMove(V, int, Move[], callback<Move>)
activate Yellow
	Yellow-->ScotlandYardModel : Consumer.accept(Ticket)
...
rnote over ScotlandYardModel: Round=4, CurrentPlayer=MrX, GameOver=true
end
@enduml
*/
//</editor-fold>
...
skinparam monochrome true
title Sample game sequence(6 player, 6 rounds)
legend right
Type legend
In package: uk.ac.bris.cs.scotlandyard.model
	S - interface Spectator
...
ScotlandYardModel->Spectator: onMoveMade(V, Ticket)
ScotlandYardModel->Spectator: onGameOver(V, [MrX,Blue,Green,Red,White,Yellow])
rnote over ScotlandYardModel: Round=6, CurrentPlayer=Yellow, GameOver=true
end
@enduml
*/
//</editor-fold>
...
ScotlandYardModel->Spectator: onMoveMade(V, Ticket)
ScotlandYardModel->Spectator: onGameOver(V, [MrX,Blue,Green,Red,White,Yellow])
rnote over ScotlandYardModel: Round=6, CurrentPlayer=MrX, GameOver=true
end
@enduml
*/
//</editor-fold>
...
skinparam monochrome true
title Sample game sequence(6 player, 3 rounds)
legend right
Type legend
In package: uk.ac.bris.cs.scotlandyard.model
	S - interface Spectator
...
ScotlandYardModel->Spectator: onMoveMade(V, Ticket)
ScotlandYardModel->Spectator: onGameOver(V, [MrX,Blue,Green,Red,White,Yellow])
rnote over ScotlandYardModel: Round=3, CurrentPlayer=MrX, GameOver=true
end
@enduml
*/
//</editor-fold>
